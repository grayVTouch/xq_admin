        ...
        <template slot="default">
            <form class="form" @submit.prevent="submitEvent">
                <table class="input-table">
                    ...
                    <tr :class="{error: val.error.release_time}">
                        <td>发布时间</td>
                        <td>
                            <DatePicker type="date" v-model="releaseTime" format="yyyy-MM-dd" @on-change="setReleaseTimeEvent" class="iview-form-input"></DatePicker>
                            <span class="need"></span>
                            <div class="msg"></div>
                            <div class="e-msg">{{ val.error.release_time }}</div>
                        </td>
                    </tr>

                    <tr :class="{error: val.error.end_time}">
                        <td>完结时间</td>
                        <td>
                            <DatePicker type="date" v-model="endTime" format="yyyy-MM-dd" @on-change="setEndTimeEvent" class="iview-form-input"></DatePicker>
                            <span class="need"></span>
                            <div class="msg"></div>
                            <div class="e-msg">{{ val.error.end_time }}</div>
                        </td>
                    </tr>
                    ...
                    <tr :class="{error: val.error.status}">
                        ...
                        <td>
                            <RadioGroup v-model="form.status">
                                <Radio v-for="(v,k) in $store.state.business.video_subject.status" :key="k" :label="k">{{ v }}</Radio>
                            </RadioGroup>
                            <span class="need">*</span>
