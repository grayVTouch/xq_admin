            ...
            <div class="line data">
                ...
                <div class="run-title">
                    <div class="left">
                        ...
                        <my-table-button type="error" @click="destroyAllEvent" :loading="val.pending.destroyAll" v-if="$store.state.context.debug" v-show="showBatchBtn"><my-icon icon="shanchu" />删除选中项 （{{ val.selectedIds.length }}）</my-table-button>
                    </div>
                    <div class="right"></div>
                </div>
