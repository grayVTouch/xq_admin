            ...
            <div class="line data">
                ...
                <div class="run-title">
                    <div class="left">
                        ...
                        <my-table-button type="error" @click="destroyAllEvent" :loading="val.pending.destroyAll" v-if="TopContext.debug" v-show="showBatchBtn"><my-icon icon="shanchu" />删除选中项 （{{ selection.length }}）</my-table-button>
                    </div>
                    <div class="right"></div>
                </div>
                ...
                <div class="table">
                    ...
                    <i-table border :height="TopContext.table.height" :columns="table.field" :data="table.data" @on-selection-change="selectionChangeEvent" :loading="val.pending.getData">
