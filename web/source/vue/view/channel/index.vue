<template>
    <div class="view">
        ...
        <div class="thumb">
            <div class="image-mask"><img :src="user.channel_thumb ? user.__channel_thumb__ : $store.state.context.res.notFound" alt="" class="image judge-img-size" v-judge-img-size></div>
            <div class="name">
                <!-- 仅在编辑模式下展示 -->
        ...
        <div class="user">
            <div class="avatar">
                <div class="image-mask">
                    <img :src="user.avatar ? user.__avatar__ : $store.state.context.res.notFound" alt="" class="image judge-img-size" v-judge-img-size>
                    <!-- 仅在编辑模式下展示 -->
                    <div class="image-editor" v-if="val.mode === 'edit'">
<!--                    <div class="image-editor">-->
        ...
        <div class="content">
            ...
            <div class="statistics">
                <div class="title" @click="onCopy" v-ripple v-clipboard :data-clipboard-text="`${$store.state.context.host}/channel/${user.id}`">
                    <my-icon icon="lianjie"></my-icon>
                    <span class="m-l-10 run-weight">{{ `${$store.state.context.host}/channel/${user.id}` }}</span>
                </div>
                <div class="count">
