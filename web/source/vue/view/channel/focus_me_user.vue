    ...
    <div class="channel-item-view">
        ...
        <div class="list m-b-20">
            ...
            <a class="item" v-for="v in data.data" target="_blank" :href="genUrl(`/channel/${v.user_id}/image`)">
                <div class="avatar">
                    <div class="image-mask"><img :src="v.user.avatar ? v.user.__avatar__ : $store.state.context.res.notFound" class="image judge-img-size" v-judge-img-size></div>
                    <div class="info">
    ...
    export default {
        ...
        methods: {
            getData () {
                ...
                Api.user.focusMeUser(this.$parent.id , {
