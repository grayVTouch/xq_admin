    ...
    <div class="channel-item-view">
        ...
        <div class="list m-b-20">
            ...
            <a class="item" v-for="v in data.data" target="_blank" :href="genUrl(`/channel/${v.focus_user_id}/image`)">
                <div class="avatar">
                    <div class="image-mask"><img :src="v.focus_user.avatar ? v.focus_user.__avatar__ : $store.state.context.res.notFound" class="image judge-img-size" v-judge-img-size></div>
                    <div class="info">
